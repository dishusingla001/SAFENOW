          ...
          <div className="flex items-center justify-between p-4 bg-dark-800 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Receive emergency alerts</p>
              </div>
            </div>
            <button
          ...
          <div className="flex items-center justify-between p-4 bg-dark-800 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Share location in emergencies</p>
              </div>
            </div>
            <button
              onClick={() => handleChange("locationSharing", !settings.locationSharing)}
              className={`relative w-14 h-7 rounded-full transition-colors ${
